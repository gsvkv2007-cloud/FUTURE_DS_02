...
- **Internet Service Impact**: Churn rates across Fiber Optic, DSL, and No Internet
- **Monthly Charges**: Contribution of different services to revenue
- **Technical Support Tickets**: Relationship between tenure and support requests
- **Paperless Billing**: Effect on churn behavior
- **Key Metrics**:
  - Total Customers: ~7K
  - Churn Rate: ~26.5%
...
- Tenure and number of technical support tickets provide signals for potential churn risk.
